    ...
    <div class="w-full flex justify-center p-4 sm:p-6">
        <div class="bg-white rounded-xl shadow-xl p-2 sm:p-6 border border-gray-100 w-full">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h4 class="text-xl sm:text-2xl font-bold text-gray-800">{{ __('layouts.freight_rate_list') }}</h4>
            ...
            <div class="overflow-x-auto">
                <table id="freightRatesTable" class="w-full text-sm border-collapse border border-gray-200">
...
@push('scripts')
    <script>
        $(document).ready(function () {
            $('#freightRatesTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('freight-rates.index') }}",
