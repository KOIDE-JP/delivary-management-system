        ...
        <div class="w-full max-w-6xl p-6 bg-white border border-gray-100 shadow-xl sm:p-8 rounded-2xl">
            ...
            <div class="flex flex-col items-start justify-between gap-4 mb-8 sm:flex-row sm:items-center">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">{{ __('layouts.order_details_for') }} <span
                            class="font-semibold text-gray-700">{{ $order->order_number }}</span></p>
                </div>
            ...
            <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                @if ($order->due_confidence == 'confirmed')
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">{{ __('layouts.confirmed') }}</span>
                                @elseif($order->due_confidence == 'unconfirmed')
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">{{ __('layouts.unconfirmed') }}</span>
                                @else
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                @if ($order->priority == 'yes')
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">{{ __('layouts.high') }}</span>
                                @else
                                    <span
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="p-6 border border-gray-100 rounded-xl bg-gray-50/50">
                        <h5
                            class="flex items-center gap-2 mb-4 text-lg font-bold text-gray-800 border-b border-gray-200 pb-2">
                            <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="space-y-4">
                                @foreach ($activityLogs as $log)
                                    <div class="relative flex gap-4 pl-2">
                                        ...
                                        {{-- Icon Circle --}}
                                        <div
                                            class="relative z-10 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center shadow-sm border-2
                                        ...
                                        <div class="flex-1 bg-white rounded-xl p-4 border border-gray-100 min-w-0">
                                            ...
                                            @if ($log->log_message)
                                                ...
                                                @if ($msg && isset($msg['key']))
                                                    ...
                                                    {{-- ADD THIS NEW ELSEIF BLOCK --}}
                                                @elseif($msg && isset($msg['custom_message']))
                                                    <p class="text-sm text-gray-600 mt-1">
                                                        {{ $msg['custom_message'] }}
                                                    </p>
                                                    {{-- END NEW BLOCK --}}
