                                ...
                                <div>
                                    ...
                                    <select name="dw_status"
                                        ...
                                        <option value="not_shipped"
                                            {{ old('dw_status', 'not_shipped') == 'not_shipped' ? 'selected' : '' }}>
                                            {{ __('layouts.not_shipped') }}
                                        </option>
                                        <option value="shipped" {{ old('dw_status') == 'shipped' ? 'selected' : '' }}>
                                            {{ __('layouts.shipped') }}
                                        </option>
                                        <option value="no_shipping_required"
                                            {{ old('dw_status') == 'no_shipping_required' ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <select name="quotation_status"
                                        ...
                                        <option value="not_submitted"
                                            {{ old('quotation_status', 'not_submitted') == 'not_submitted' ? 'selected' : '' }}>
                                            {{ __('layouts.not_submitted') }}
                                        </option>
                                        <option value="submitted"
                                            {{ old('quotation_status') == 'submitted' ? 'selected' : '' }}>
                                            {{ __('layouts.submitted') }}
                                        </option>
                                        <option value="not_required"
                                            {{ old('quotation_status') == 'not_required' ? 'selected' : '' }}>
                                            {{ __('layouts.not_required') }}
                                        </option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="order_status"
                                        ...
                                        <option value="received"
                                            {{ old('order_status') == 'received' ? 'selected' : '' }}>
                                            {{ __('layouts.received') }}
                                        </option>
                                        <option value="not_required"
                                            {{ old('order_status') == 'not_required' ? 'selected' : '' }}>
                                            {{ __('layouts.not_required') }}
                                        </option>
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div>
                                        ...
                                        <select name="inspection_slip_status"
                                            ...
                                            <option value="not_received"
                                                {{ old('inspection_slip_status', 'not_received') == 'not_received' ? 'selected' : '' }}>
                                                {{ __('layouts.not_received') }}</option>
                                            <option value="received"
                                                {{ old('inspection_slip_status') == 'received' ? 'selected' : '' }}>
                                                {{ __('layouts.received') }}</option>
                                            <option value="not_required"
                                                {{ old('inspection_slip_status') == 'not_required' ? 'selected' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <select name="invoice_status"
                                            ...
                                            <option value="sent"
                                                {{ old('invoice_status') == 'sent' ? 'selected' : '' }}>
                                                {{ __('layouts.sent') }}
                                            </option>
                                            <option value="not_required"
                                                {{ old('invoice_status') == 'not_required' ? 'selected' : '' }}>
                                                {{ __('layouts.not_required') }}
                                            </option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" name="order_amount"
                                                value="{{ old('order_amount') ? number_format(old('order_amount')) : '' }}"
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input readonly type="text" name="freight_master_price"
                                        value="{{ old('freight_master_price') }}" placeholder="0.00"
                                        class="show_formatted_amount block w-full py-2.5 pl-8 pr-4 text-sm text-gray-900 bg-gray-100 border @error('freight_master_price') border-red-500 ring-1 ring-red-500 @else border-gray-300 @enderror rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors cursor-not-allowed opacity-60">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="freight_price" inputmode="numeric" autocomplete="off"
                                        value="{{ old('freight_price') }}" placeholder="0"
                                        class="show_formatted_amount block w-full py-2.5 pl-8 pr-4 text-sm text-gray-900 bg-white border @error('freight_price') border-red-500 ring-1 ring-red-500 @else border-gray-300 @enderror rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                </div>
                                @error('freight_price')
                                    <p class="mt-1 text-xs text-red-600 error-text">{{ $message }}</p>
                                @enderror
