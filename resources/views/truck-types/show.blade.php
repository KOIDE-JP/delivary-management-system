...
<div class="min-h-screen py-8 sm:py-12 px-4 sm:px-6">
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">{{ __('layouts.truck_type_details') }}</h1>
            </div>
            <div class="flex gap-2">
                <a href="{{ route('truck-types.edit', $truckType->id) }}"
        ...
        <div class="gradient-border rounded-2xl p-6 sm:p-8 bg-white shadow-lg border border-gray-200">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p class="text-gray-800 font-semibold">{{ $truckType->created_at->format('Y-m-d H:i') }}</p>
                </div>
            </div>
        </div>
