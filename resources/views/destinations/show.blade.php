...
<div class="min-h-screen py-8 sm:py-12 px-4 sm:px-6">
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">{{ __('layouts.destination_details') }}</h1>
            </div>
        ...
        <div class="gradient-border rounded-2xl p-6 sm:p-8 bg-white shadow-lg border border-gray-200">
            <h2 class="text-base font-semibold text-gray-700 mb-5 flex items-center gap-2">
                ...
                {{ __('layouts.destination_information') }}
            </h2>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p class="text-xs text-gray-400 uppercase tracking-wide font-medium mb-1">{{ __('layouts.prefix') }}</p>
                    <p class="text-gray-800 font-semibold">{{ $destination->prefix ?? '-' }}</p>
                </div>
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p class="text-xs text-gray-400 uppercase tracking-wide font-medium mb-1">{{ __('layouts.name') }}</p>
                    <p class="text-gray-800 font-semibold">{{ $destination->name }}</p>
                </div>
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                ...
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    ...
                    <p class="text-gray-800 font-semibold">{{ $destination->created_at->format('Y-m-d H:i') }}</p>
                </div>
            </div>
        </div>
