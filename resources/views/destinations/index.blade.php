    ...
    <div class="w-full flex justify-center p-4 sm:p-6">
        <div class="bg-white rounded-xl shadow-xl p-2 sm:p-6 border border-gray-100 w-full">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h4 class="text-xl sm:text-2xl font-bold text-gray-800">{{ __('layouts.destination_list') }}</h4>
            ...
            <div class="overflow-x-auto">
                <table id="destinationsTable" class="w-full text-sm border-collapse border border-gray-200">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            <th class="px-4 py-2 text-center">#</th>
                            <th class="px-4 py-2 text-left">{{ __('layouts.prefix') }}</th>
        ...
        $(document).ready(function () {
            $('#destinationsTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'prefix', name: 'prefix', className: 'text-left' },
