        ...
        <div class="max-w-2xl mx-auto">
            <div class="form-card gradient-border rounded-2xl p-6 sm:p-8 md:p-10 bg-white shadow-lg border border-gray-200">
                <div class="relative z-10">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">{{ __('layouts.add_destination') }}</h2>
                    ...
                    <form action="{{ route('destinations.store') }}" method="POST" class="space-y-6">
                        ...
                        {{-- Prefix --}}
                        <div class="relative">
                            <input placeholder=" " id="prefix" name="prefix" type="text"
                                value="{{ old('prefix') }}" maxlength="2"
