...
return [
    ...
    'order' => [
        ...
        'import' => '注文をインポート',
        'import_description' => 'Excelシートをアップロードして注文レコードを作成します。',
        'upload_instruction' => 'クリックしてアップロードするか、ファイルをドラッグアンドドロップしてください',
        'upload_ins_files' => '.XLSX, .XLS, or .CSV (最大10MB)',
        'start_import' => 'インポートを開始',
        'uploading_file' => 'ファイルをアップロード中...',
        'import_complete' => '注文が正常にインポートされました！',
